...
class Neuron:
    ...
    # gray = zero activation
    # black = negative activation
    def draw(self, radius):
        circle = pyplot.Circle((self.x, self.y), radius=radius, edgecolor='black',
                               facecolor=(self.color, self.color, self.color))
...
class Layer:
    ...
    def __init__(self, network, number_of_neurons, number_of_neurons_in_widest_layer, activations, weights):
        ...
        self.neurons = self.__initialize_neurons()
    ...
    def __line_between_two_neurons(self, neuron1, neuron2, weight):
        ...
        line = pyplot.Line2D((neuron1.x-x_adjustment, neuron2.x+x_adjustment),
                             (neuron1.y-y_adjustment, neuron2.y+y_adjustment), color=color,
